    ...
    <Container>
      ...
      <HeaderTabView>
        { listState === 1
          ? (
            <UpperTabSelectedView>
              <UpperTabSelectedText>People</UpperTabSelectedText>
            </UpperTabSelectedView>
          )
          : (
            <UpperTabView onPress={() => loadWorkers('')}>
        ...
        { listState === 2
          ? (
            <UpperTabSelectedView>
              <UpperTabSelectedText>Clubs</UpperTabSelectedText>
            </UpperTabSelectedView>
          )
          : (
            <UpperTabView>
              <UpperTabText onPress={() => handleClubs()}>Clubs</UpperTabText>
            </UpperTabView>
          )
        }
      </HeaderTabView>
